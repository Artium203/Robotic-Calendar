...
public class VoiceCaller {
    ...
    public VoiceCaller(String voiceFile) {
        // Input data
        String[] texts = {
                "Here is a calendar where you can see you tas by name at the time you putted it. Use the two buttons tow move between time, on top you can see the year and month",
                "Here is a list of your resent putted actions by date and time.",
                ...
                "Here you can go forward ot backward between each task.",
        ...
        String outputAudio = "C:\\Users\\artem\\IdeaProjects\\untitled\\python";

        // Python script path
        String pythonScript = "C:\\Users\\artem\\IdeaProjects\\untitled\\python\\speak2.0.py";

        // Build the command to execute the Python script with arguments
        for (int i = 0; i < texts.length; i++) {
            String outputPath = outputAudio + "_" + i + ".wav";
            String text = texts[i];

            ProcessBuilder processBuilder = new ProcessBuilder(
                    "python", pythonScript, text, referenceAudio, outputPath
            );
            ...
            try {
                ...
                System.out.println("Process for text " + i + " exited with code " + exitCode);
